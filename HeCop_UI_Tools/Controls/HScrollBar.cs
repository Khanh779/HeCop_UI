...
namespace HecopUI_Winforms.Controls
{
    ...
    public class HScrollBar : Control
    {
        ...
        public Color HoverThumbColor { get; set; } = GetAppResources.GetHoverColor();
        private Color thumbColor = GetAppResources.GetColorNormal();
        ...
        private void DrawScrollBar(Graphics g, Color hoverThumbColor, Color thumbColor, Color barColor)
        {
            ...
            GraphicsPath gp = DrawHelper.GetRoundPath(ClientRectangle, barradi);
            GraphicsPath gp1 = DrawHelper.GetRoundPath(thumbRectangle, thradius);
            {
