    ...
    public partial class HRichTextBox : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            g.FillPath(new SolidBrush(Hover ? RichTextBoxHoverColor : richTextBox.BackColor),
                DrawHelper.GetRoundPath(ClientRectangle, Radius, BorderThickness));
            if (BorderThickness != 0)
                g.DrawPath(new Pen(new SolidBrush(richTextBox.Focused ?
                    DrawHelper.BlendColor(BorderHoverColor, BorderFocusColor, _animationManager.GetProgress() * 255) :
                    Hover ? DrawHelper.BlendColor(bc, BorderHoverColor, _animationManager.GetProgress() * 255) :
                    DrawHelper.BlendColor(BorderColor, BorderHoverColor, _animationManager.GetProgress() * 255)),
                    BorderThickness),
                    DrawHelper.GetRoundPath(ClientRectangle, Radius, BorderThickness));
        ...
        private Color bc = GetAppResources.GetBorderColor();
        ...
        private Color bhc = GetAppResources.GetHoverColor();
        ...
        public Color BorderFocusColor { get; set; } = HecopUI_Winforms.GetAppResources.GetBorderColor();
    }
}