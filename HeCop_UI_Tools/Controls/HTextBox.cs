...
namespace HecopUI_Winforms.Controls
{
    ...
    public partial class HTextBox : Control
    {
        ...
        private Color borderColor = GetAppResources.GetColorNormal();
        ...
        private Color borderHoverColor = GetAppResources.GetHoverColor();
        private Color borderFocusColor = GetAppResources.GetDownColor();
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            GraphicsPath Gp = DrawHelper.GetRoundPath(new RectangleF(0, 0,
            ...
            switch (style)
            {
                case TextBoxStyle.Style1:
                    g.FillPath(new SolidBrush( tbCtrl.BackColor), DrawHelper.GetRoundPath(new RectangleF(0, 0, Width, Height), Radius, BorderThickness));
                    if (BorderThickness >= 0)
                        g.DrawPath(pen, DrawHelper.GetRoundPath(new RectangleF(0, 0, Width, Height), Radius, BorderThickness));
                    break;
