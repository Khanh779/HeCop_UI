...
namespace HecopUI_Winforms.Controls
{
    public partial class HCheckBox : Control
    {
        ...
        Color enabledCheckedColor = HecopUI_Winforms.GetAppResources.GetColorNormal();
        ...
        protected override void OnPaint(PaintEventArgs pevent)
        {
            ...
            using (var checkmarkPath = HecopUI_Winforms.DrawHelper.GetRoundPath(new RectangleF(6f, 6, 15, 15), 0))
        ...
        Color fbc = GetAppResources.GetBorderColor();
