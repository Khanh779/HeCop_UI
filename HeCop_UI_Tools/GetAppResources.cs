...
namespace HecopUI_Winforms
{
    public partial class GetAppResources
    {
                        ...
                        if (p.Id != currentProcess.Id) // Check running process   
                        {
                            if (p.ProcessName.Equals(currentProcess.ProcessName) == true)
                            {
                                ...
                                if (User32.IsIconic(hFound)) // If application is in ICONIC mode then  
                                    User32.ShowWindow(hFound, User32.SW_RESTORE);
                                HecopUI_Winforms.Win32.User32.SetForegroundWindow(hFound); // Activate the window, if process is already running  
        ...
        public static void Animate(Control ctl, Effect effect, int msec, int angle)
        {
            ...
            bool ok = HecopUI_Winforms.Win32.User32.AnimateWindow(ctl.Handle, msec, flags);
        ...
        {
            Bitmap aBmp = null;
            IntPtr screenDC = HecopUI_Winforms.Win32.User32.GetDC(IntPtr.Zero);
            IntPtr memDC = HecopUI_Winforms.Win32.Gdi32.CreateCompatibleDC(screenDC);
            IntPtr hBitmap = IntPtr.Zero;
            IntPtr oldBitmap = IntPtr.Zero;
            try
            {
                hBitmap = aBmp.GetHbitmap(Color.FromArgb(0));
                oldBitmap = HecopUI_Winforms.Win32.Gdi32.SelectObject(memDC, hBitmap);
                ...
                HecopUI_Winforms.Win32.Enums.BLENDFUNCTION blend = new HecopUI_Winforms.Win32.Enums.BLENDFUNCTION();
                blend.BlendOp = HecopUI_Winforms.GetAppResources.Win32.AC_SRC_OVER;
                blend.BlendFlags = 0;
                blend.SourceConstantAlpha = 255;
                blend.AlphaFormat = HecopUI_Winforms.GetAppResources.Win32.AC_SRC_ALPHA;
                HecopUI_Winforms.Win32.User32.UpdateLayeredWindow(control.Handle, screenDC, ref topPos, ref size, memDC, ref pointSource, 0, ref blend, HecopUI_Winforms.GetAppResources.Win32.ULW_ALPHA);
            }
            catch
            {
            }
            ...
            {
                HecopUI_Winforms.Win32.User32.ReleaseDC(IntPtr.Zero, screenDC);
                if (hBitmap != IntPtr.Zero)
                {
                    HecopUI_Winforms.Win32.Gdi32.SelectObject(memDC, oldBitmap);
                    HecopUI_Winforms.Win32.Gdi32.DeleteObject(hBitmap);
                }
                HecopUI_Winforms.Win32.Gdi32.DeleteDC(memDC);
            }
            return aBmp;
        }
        ...
        {
            return Color.FromArgb(0, 168, 142);
        }
        ...
        public static Color GetDownColor()
        {
            return Color.FromArgb(0, 148, 122);
        }

        public static Color GetHoverColor()
        {
            return Color.FromArgb(0, 188, 162);
        }
        ...
        {
            return ColorTranslator.FromHtml("#00a88e");
        }

        public static Color GetBaseProgressBarColor()
        {
            return Color.FromArgb(230, 230, 230);
        }

        public static Color GetBorderProgressBarColor()
        {
