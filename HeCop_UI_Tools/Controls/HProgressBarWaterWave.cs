        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            switch (ProgressShape)
            {
                ...
                case ProgressShapeType.RoundRectangle:
                    e.Graphics.FillPath(new TextureBrush(ProgressImage), DrawHelper.GetRoundPath(ClientRectangle, Radius));
                    e.Graphics.DrawPath(new Pen(new SolidBrush(BorderColor), BorderThickness), DrawHelper.GetRoundPath(ClientRectangle, Radius, BorderThickness));
                    break;
            }
        }
