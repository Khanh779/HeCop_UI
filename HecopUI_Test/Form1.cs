...
namespace HecopUI_Test
{
    public partial class Form1 : HecopUI_Winforms.Forms.HForm
    {
        ...
        void loadDataChart()
        {
            ...
            // Ví dụ mẫu đi
            List<HecopUI_Winforms.Controls.Charts.Series> series = new List<HecopUI_Winforms.Controls.Charts.Series>();
            
            HecopUI_Winforms.Controls.Charts.Series s1 = new HecopUI_Winforms.Controls.Charts.Series();
            s1.Text = "Example 1";
            s1.Values = new float[] { 10, 20, 30, 40, 50, 60 };
            s1.Color = Color.MediumVioletRed;

            HecopUI_Winforms.Controls.Charts.Series s2 = new HecopUI_Winforms.Controls.Charts.Series();
            s2.Text = "Example 2";
            s2.Values = new float[] { 60, 50, 40, 30, 20, 10 };
            s2.Color = Color.MediumSeaGreen;

            HecopUI_Winforms.Controls.Charts.Series s3 = new HecopUI_Winforms.Controls.Charts.Series();
            s3.Text = "Example 3";
