...
namespace HecopUI_Winforms.Controls
{
    public partial class hColorPicker : UserControl
    {
        ...
        private void HColorPicker_ValueChanged(object sender, EventArgs e)
        {
            ...
            hTextBox2.Text = hhTrackBar12.Value.ToString();
            hTextBox3.Text = hhTrackBar13.Value.ToString();
            hRadiusPanel4.PanelColor1 = hRadiusPanel4.PanelColor2 = Color.FromArgb(255, hhTrackBar11.Value, hhTrackBar12.Value, hhTrackBar13.Value);
            TB_HtmlCode.Text = ColorTranslator.ToHtml(hRadiusPanel4.PanelColor1);
        }
