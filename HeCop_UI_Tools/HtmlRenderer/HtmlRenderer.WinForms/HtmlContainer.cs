...
using HecopUI_Winforms.HtmlRenderer.Adapters.Entities;
using HecopUI_Winforms.HtmlRenderer.Core;
using HecopUI_Winforms.HtmlRenderer.Core.Entities;
using HecopUI_Winforms.HtmlRenderer.Core.Parse;
using HecopUI_Winforms.HtmlRenderer.Core.Utils;
using HecopUI_Winforms.HtmlRenderer.WinForms.Adapters;
using HecopUI_Winforms.HtmlRenderer.WinForms.Utilities;
using System;
...
namespace HecopUI_Winforms.HtmlRenderer.WinForms
{
    /// <summary>
