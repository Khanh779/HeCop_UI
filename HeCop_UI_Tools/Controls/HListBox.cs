...
namespace HecopUI_Winforms.Controls
{
    ...
    public class HListBox : Control
    {
        ...
        private Color _borderColor = GetAppResources.GetBorderColor();
        ...
        private Color thumbColor = GetAppResources.GetHoverColor();
        ...
        private Color selectedItemColor = GetAppResources.GetColorNormal();
        private Color hoveredItemColor = GetAppResources.GetHoverColor();
        private Color itemNormalColor = GetAppResources.GetColorNormal();
