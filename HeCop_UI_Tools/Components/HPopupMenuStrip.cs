...
namespace HecopUI_Winforms.Components
{
    /// <summary>
    ...
    public partial class HPopupMenuStrip : ToolStripDropDown
    {
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the <see cref="HecopUI_Winforms.Popup" /> is resizable.
        /// </summary>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether the <see cref="HecopUI_Winforms.Popup"></see> acts like a transparent windows (so it cannot be clicked).
        /// </summary>
        /// <value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="HecopUI_Winforms.Popup"/> class.
        /// </summary>
        ...
        public HPopupMenuStrip(Control content)
        {
            ...
            if (User32.IsRunningOnMono) content.Margin = Padding.Empty;
            MinimumSize = content.MinimumSize;
            content.MinimumSize = content.Size;
            MaximumSize = content.MaximumSize;
            content.MaximumSize = content.Size;
            Size = content.Size;
            if (User32.IsRunningOnMono) _host.Size = content.Size;
        ...
        protected override void OnVisibleChanged(EventArgs e)
        {
            ...
            if (User32.IsRunningOnMono) return; // in case of non-Windows
            if ((Visible && ShowingAnimation == PopupAnimations.None) || (!Visible && HidingAnimation == PopupAnimations.None))
            {
                return;
            }
            User32.AnimationFlags flags = Visible ? User32.AnimationFlags.Roll : User32.AnimationFlags.Hide;
            ...
            flags = flags | (User32.AnimationFlags.Mask & (User32.AnimationFlags)(int)_flags);
            User32.SetTopMost(this);
            User32.AnimateWindow(this, AnimationDuration, flags);
        }
        ...
        {
            if (m.Msg == User32.WM_NCACTIVATE && m.WParam != IntPtr.Zero && _childPopup != null && _childPopup.Visible)
            {
                _childPopup.Hide();
            }
            ...
            else if (m.Msg == User32.WM_GETMINMAXINFO)
            {
        ...
        {
            User32.MINMAXINFO minmax = (User32.MINMAXINFO)Marshal.PtrToStructure(m.LParam, typeof(User32.MINMAXINFO));
        ...
        private bool OnNcHitTest(ref Message m, bool contentControl)
        {
            if (NonInteractive)
            {
                m.Result = (IntPtr)User32.HTTRANSPARENT;
                return true;
            }
            ...
            IntPtr transparent = new IntPtr(User32.HTTRANSPARENT);

            if (_resizableTop)
            {
                if (_resizableLeft && gripBouns.TopLeft.Contains(clientLocation))
                {
                    m.Result = contentControl ? transparent : (IntPtr)User32.HTTOPLEFT;
                    return true;
                }
                if (!_resizableLeft && gripBouns.TopRight.Contains(clientLocation))
                {
                    m.Result = contentControl ? transparent : (IntPtr)User32.HTTOPRIGHT;
                    return true;
                }
                if (gripBouns.Top.Contains(clientLocation))
                {
                    m.Result = contentControl ? transparent : (IntPtr)User32.HTTOP;
                    return true;
                }
            }
            else
            {
                ...
                {
                    m.Result = contentControl ? transparent : (IntPtr)User32.HTBOTTOMLEFT;
                    return true;
                }
                if (!_resizableLeft && gripBouns.BottomRight.Contains(clientLocation))
                {
                    m.Result = contentControl ? transparent : (IntPtr)User32.HTBOTTOMRIGHT;
                    return true;
                }
                if (gripBouns.Bottom.Contains(clientLocation))
                {
                    m.Result = contentControl ? transparent : (IntPtr)User32.HTBOTTOM;
                    return true;
                }
            }
            if (_resizableLeft && gripBouns.Left.Contains(clientLocation))
            {
                m.Result = contentControl ? transparent : (IntPtr)User32.HTLEFT;
                return true;
            }
            if (!_resizableLeft && gripBouns.Right.Contains(clientLocation))
            {
                m.Result = contentControl ? transparent : (IntPtr)User32.HTRIGHT;
                return true;
            }
            return false;
        }
