...
namespace HecopUI_Winforms.Controls
{
    ...
    public partial class HDigitalGauge : Control
    {
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            GraphicsPath gp = DrawHelper.GetRoundPath(ClientRectangle, rad);
            g.FillPath(new SolidBrush(_GaugeColor), gp);
            g.DrawPath(new Pen(new SolidBrush(borC), Borw) { Alignment = PenAlignment.Inset }, DrawHelper.GetRoundPath(ClientRectangle, rad, BorderThickness));
