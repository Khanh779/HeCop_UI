...
namespace HecopUI_Winforms.Controls
{
    ...
    public partial class HCircularProgressBar1 : Control
    {
        ...
        public HCircularProgressBar1()
        {
            ...
            ProgressColor1 = ProgressColor2 = GetAppResources.GetProgressBarColor();
            DoubleBuffered = true;
        }
        ...
        private Color CenteC1 = GetAppResources.GetBaseProgressBarColor();
        private Color CenteC2 = GetAppResources.GetBaseProgressBarColor();
