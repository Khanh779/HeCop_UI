...
namespace HecopUI_Winforms.Controls
{
    ...
    public partial class HToggleButton : Control
    {
        ...
        private Color OnCol = GetAppResources.OnToggleButtonColor();
        private Color OffCol = GetAppResources.OffToggleButtonColor();
        ...
        private Color LC = GetAppResources.LeverToggleButtonColor();
