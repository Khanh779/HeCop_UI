...
namespace HecopUI_Winforms.Controls
{
    public partial class HMontCalendar : Control
    {
        ...
        private new Font Font = HecopUI_Winforms.Extensions.HFonts.GetFont(Properties.Resources.Roboto_Regular, 10);
        ...
        private Color previousButtonHover = GetAppResources.GetHoverColor();
        ...
        private Color daySelected = GetAppResources.GetDownColor();
        private Color dayHover = GetAppResources.GetHoverColor();
        ...
        void TitleTime(Graphics graphics, StringFormat SF)
        {
            ...
            graphics.FillPath(new SolidBrush(TitleColor), DrawHelper.GetRoundPath(new RectangleF((Width - a.Width) / 2, TopDateRect.Top + 5, a.Width + 10, a.Height + 10), 4, 0));
        ...
        protected override void OnPaint(PaintEventArgs e)
        {
            ...
            var bg = DrawHelper.GetRoundPath(ClientRectangle, 1, 1);
            ...
            for (int i = 0; i < 42; i++)
            {
                ...
                if (HoverX == i / 7 && HoverY == i % 7)
                {
                    ...
                    var bg1 = DrawHelper.GetRoundPath(new RectangleF(rect1.X + 2, rect1.Y + 2, rect1.Width - 4, rect1.Width - 4), 3);
